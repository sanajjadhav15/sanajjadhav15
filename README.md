# Hi there, I'm Sanaj Jadhav! 👋

<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=2196F3&center=true&vCenter=true&width=435&lines=Data+Analyst+%26+Developer;Python+%7C+SQL+%7C+React+Enthusiast;Turning+Data+into+Insights;Open+to+Collaboration!" alt="Typing SVG" />
</div>
...
- **Features:** Automated statistics generation, smart visualizations, exportable reports
- **Impact:** Significantly reduced manual analysis time for data scientists
...
- **Features:** Content consumption analysis, viewing trends, user behavior insights
- **Impact:** Data-driven recommendations for content strategy
...
- **Features:** Real-time search, dynamic data fetching, responsive design
- **Impact:** Enhanced user experience with interactive robot directory
...
### 🌐 Web Developer | Vionsys IT Solutions India Pvt. Ltd.
**Jun 2024 – Jul 2024 | Pune, MH**
- Developed responsive web solutions using **ReactJS** and **Next.js**
- Collaborated with cross-functional teams for feature implementation
- Contributed to performance analysis and optimization

### 🌾 Geofencing Intern | Godavari Biorefineries Ltd.
**Jun 2023 – Jul 2023 | Bagalkot, KA**
- Mapped agricultural land using **Google Earth** and **Excel**
- Conducted field visits and collected crop data
- Analyzed geographical data for optimal land usage patterns
